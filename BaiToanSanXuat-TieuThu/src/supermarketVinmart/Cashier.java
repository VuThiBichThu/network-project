...
public class Cashier extends JFrame {
	...
	private void initialize() {
		...
		lbHead.setBounds(200, 11, 563, 22);
		frame.getContentPane().add(lbHead);

		JSeparator separator = new JSeparator();
		separator.setBounds(10, 43, 662, 2);
		frame.getContentPane().add(separator);

		JSeparator separator_1 = new JSeparator();
		separator_1.setBounds(10, 93, 662, 2);
		frame.getContentPane().add(separator_1);

		btnStart = new JButton("START");
		btnStart.setBounds(402, 56, 79, 26);
		setButton(btnStart);
		...
		btnReset.setBounds(498, 56, 73, 26);
		setButton(btnReset);
		...
		btnExit.setBounds(588, 56, 73, 26);
		setButton(btnExit);
		...
		lbChair.setBounds(10, 59, 150, 22);
		frame.getContentPane().add(lbChair);

		txtChair = new JTextField();
		txtChair.setBounds(150, 62, 50, 20);
